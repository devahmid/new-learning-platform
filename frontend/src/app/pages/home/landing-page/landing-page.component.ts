...
@Component({
    ...
    <section class="mx-auto max-w-6xl px-4 pt-24 md:pt-28">
      <a routerLink="/reinscription" class="block rounded-[28px] border border-amber-200 bg-gradient-to-r from-amber-50 via-white to-emerald-50 p-5 md:p-6 shadow-[0_20px_60px_rgba(15,23,42,.10)] hover:shadow-[0_25px_70px_rgba(15,23,42,.14)] transition-all duration-300 no-underline">
