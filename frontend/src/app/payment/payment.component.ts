...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SpinnerComponent, FormsModule, PaypalPaymentComponent],
  template: `
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4">
              <!-- Stripe - Désactivé -->
              <div class="w-full p-4 border-2 border-gray-200 rounded-lg bg-gray-50 opacity-60 cursor-not-allowed">
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-3">
                    ...
                    <div class="text-left">
                      <div class="font-semibold text-gray-500">Stripe</div>
                      <div class="text-sm text-gray-400">Bientôt disponible</div>
                    </div>
                  </div>
            ...
            <div class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
              <div class="flex items-start">
                ...
                <div class="text-sm text-green-800">
                  ...
                  <p class="mt-1">Vos données sont protégées par un cryptage SSL et PayPal. Stripe sera disponible bientôt.</p>
                </div>
              </div>
            </div>
          </div>
...
export class PaymentComponent implements OnInit {
  ...
  // payWithStripe() - Désactivé temporairement
  // payWithStripe() {
  //   // Méthode désactivée - Stripe sera disponible bientôt
  // }
